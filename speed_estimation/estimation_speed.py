...
class EstimationSpeehRTSPOut:
    def __init__(
        ...
        self.updsink_port_num = updsink_port_num
        self.host = host
                    ...
                    try:
                        ...
                        if (
                            ...
                            if user_meta_data.lcStatus:
                                # print("ObjectID: {0} | classID: {1}".format(obj_meta.object_id, obj_meta.class_id))
    ...
    def main(self):
        ...
        updsink_port_num = self.updsink_port_num
        ...
        server.props.service = "%d" % self.rtsp_port_num
        server.attach(None)
